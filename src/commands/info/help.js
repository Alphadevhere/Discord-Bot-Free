  ...
  run(message, args) {
    ...
    if (
      ...
      embed // Build specific command help embed
        ...
        .setThumbnail('https://miro.medium.com/max/1400/1*t_oZx2rLtqgPlv9qP-0aQQ.png')
      ...
      embed // Build help embed
        ...
        .setTimestamp()
        .setImage('https://miro.medium.com/max/1400/1*t_oZx2rLtqgPlv9qP-0aQQ.png')
        .setColor(message.guild.me.displayHexColor);
      ...
      embed.addField(
        '**Links**', 
        '**[Invite Me](https://discord.com/api/oauth2/authorize?client_id=883625801524842537&permissions=8&scope=bot) | ' +
